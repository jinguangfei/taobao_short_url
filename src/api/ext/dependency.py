...
from src.gateway.sync.user.controllers import (
    sync_api_controller,
...
class SyncTokenControl:
    ...
    @classmethod
    async def validate_token(cls, api_name : str , account_info: AccountInfo= Depends(AccountTokenControl.validate_token)) -> UserSyncAPI:
